...
# ── Paths — override via environment variables or edit below ──────
_root = _Path(__file__).parent.parent  # project root

QDRANT_PATH    = os.getenv("QDRANT_PATH",    str(_root / "qdrant_data"))
EMBEDDING_MODEL = os.getenv("EMBEDDING_MODEL", "nomic-embed-text")
EMBEDDING_DIM  = 768  # nomic-embed-text dimension

CLAUDE_DATA_DIR = os.getenv("CLAUDE_DATA_DIR", str(_root / "data" / "claude"))
PROJECTS_DIR    = os.getenv("PROJECTS_DIR",    str(_Path.home() / "Projects"))
RESUME_PATH     = os.getenv("RESUME_PATH",     str(_Path.home() / "Documents" / "Resume.pdf"))
